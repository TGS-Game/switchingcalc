...
export default function ReconciliationPage() {
  ...
  return (
    <div className="stack">
      ...
      <p>
        Obvious rows are shown first and auto-ticked. Use the filters to narrow the list,
        then approve selected rows in bulk.
      </p>
      ...
      <div className="card" style={{ padding: 12 }}>
        ...
        >
          ...
          <label>
            ...
            <select value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)} style={{ width: '100%', padding: 8 }}>
              <option value="all">all</option>

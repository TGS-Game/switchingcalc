      ...
      <div className="card" style={{ padding: 10 }}>
        <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ fontSize: 11, color: '#475569' }}>
            Bank transfer and ZA rows are hidden from this list.
          </div>
        </div>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 1280 }}>
          <thead>
            <tr style={{ background: '#e2e8f0' }}>
              ...
              <th style={cellStyle}>Received Grams</th>
            ...
            {orderedCases.map((item) => {
              ...
              return (
                <tr key={item.id} style={{ background: isSelected ? '#f8fafc' : '#ffffff' }}>
                  ...
                  <td style={{ ...cellStyle, minWidth: 200, maxWidth: 260 }}>

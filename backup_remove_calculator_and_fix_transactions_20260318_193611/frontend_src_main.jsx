      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: '#e5e7eb' }}>
        <aside style={{
          ...
          <nav style={{ display: 'grid', gap: 8 }}>
            ...
            <NavItem to="/reconciliation" label="Reconciliation" icon="🧾" collapsed={collapsed} />
            <NavItem to="/transactions" label="Transactions" icon="📘" collapsed={collapsed} />
            <NavItem to="/calculator" label="Calculator" icon="🧮" collapsed={collapsed} />
            <NavItem to="/alerts" label="Alerts" icon="🔔" collapsed={collapsed} />
          </nav>
